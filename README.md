...
- **Blackjack 3D made with Unity** [https://github.com/FernMiran/Blackjack-3D] - A 3D implementation of the classic game made with Unity, with a decoupled architecture, realistic 3D card animations, an intuitive user interface, and adheres to standard Blackjack rules.
